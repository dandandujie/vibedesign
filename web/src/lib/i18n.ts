...
const EN: Record<string, string> = {
  ...
  "刚刚": "just now",
  "站点 ZIP": "Site ZIP",
  "全部页面文件 + SITE-MANIFEST.json": "All page files + SITE-MANIFEST.json",
  "开启新会话（保留画布，清空对话）": "New session (keep canvas, clear chat)",
  "多页站点暂不支持批注": "Annotate is not supported on multi-page sites yet",
  "多页站点暂不支持换肤": "Palette shift is not supported on multi-page sites yet",
  ...
  "手机": "Mobile",
  "预览设备": "Preview device",
  "移动端（手机壳预览）": "Mobile (phone shell preview)",
  "移动端应用（手机壳 + 状态栏）": "Mobile app (phone shell + status bar)",
  "帧率": "Frame rate",
  "尺寸": "Size",
  "开始渲染": "Start render",
  "MP4/WebM · 可选帧率与尺寸": "MP4/WebM · fps & size options",
  "版本管理": "Version manager",
  "版本管理（搜索 / 预览 / 恢复 / 导出）": "Version manager (search / preview / restore / export)",
  "搜索版本（名称 / prompt / v3）": "Search versions (name / prompt / v3)",
  "没有匹配的版本": "No matching versions",
  "选择一个版本查看预览": "Select a version to preview",
  "在画布打开": "Open on canvas",
  "恢复为此版本": "Restore this version",
  ...
  "左右": "Side by side",
  "上下": "Stacked",
  "左右各一半": "Side by side (50/50)",
  "上下各一半": "Stacked (50/50)",
  "预览": "Preview",
  "iPhone · 深色": "iPhone · Dark",
  "iPhone · 浅色": "iPhone · Light",
  "Android · Pixel": "Android · Pixel",
  "iPhone SE · 小屏": "iPhone SE · Small",
  "iPad · 平板": "iPad · Tablet",
  "简约边框": "Minimal",
  "真机壳样式": "Phone shell style",
  "添加页面": "Add page",
  "当前页操作": "Current page actions",
  "重命名标题": "Rename title",
  "左移": "Move left",
  "右移": "Move right",
  "删除页面": "Delete page",
  "页面标题": "Page title",
  "新页面标题": "New page title",
  "新页面": "New page",
  "页面调整": "page edit",
  "占位页 — 在对话里说「完善 ": "Placeholder — ask in chat: \"finish the ",
  " 页」让模型设计它": " page\" to have the model design it",
  "分钟前": "m ago",
  "小时前": "h ago",
  "天前": "d ago",
  "副本": "copy",
