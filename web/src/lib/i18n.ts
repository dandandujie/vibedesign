...
const EN: Record<string, string> = {
  ...
  "准备设计上下文": "Prepare design context",
  "正在准备设计上下文": "Preparing design context",
  "连接模型服务": "Connect to model service",
  "正在等待模型响应": "Waiting for the model",
  "生成设计内容": "Generate design content",
  "正在生成设计内容": "Generating design content",
  "整理结果并更新画布": "Finalize and update canvas",
  "正在整理结果并更新画布": "Finalizing and updating canvas",
  "正在处理": "Working",
  "模型响应较慢，仍在等待": "The model is taking longer; still waiting",
  "暂时没有收到新进度": "No new progress received yet",
  "设计已完成": "Design complete",
  "生成已停止": "Generation stopped",
  "生成遇到问题": "Generation encountered a problem",
  "可以继续等待；若长时间没有变化，可停止后重试。": "You can keep waiting. If nothing changes for a while, stop and try again.",
  "Agent 正在创建设计": "Agent is creating your design",
  "首个可预览版本生成后会自动显示": "The first previewable version will appear automatically",
