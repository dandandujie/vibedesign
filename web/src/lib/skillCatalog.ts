      ...
      },
      {
        ...
        inputs: {
          ...
          questions: [
            ...
            { id: "pricing", label: "要不要定价区块", type: "toggle", on: "要", off: "不要", defaultValue: "要" },
            { id: "proof_count", label: "社会证明数量（logo / 评价）", type: "number", min: 0, max: 6, step: 1, defaultValue: 3 },
      ...
      },
      {
        ...
        inputs: {
          ...
          questions: [
            ...
            { id: "notes", label: "要演讲者逐字稿吗", type: "toggle", on: "要（含备注）", off: "不用", defaultValue: "要（含备注）" },
            { id: "slides", label: "大致页数", type: "number", min: 3, max: 40, step: 1, defaultValue: 12 },
          ],
        },
      },
    ],
